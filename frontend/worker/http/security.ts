...
export const CONTENT_SECURITY_POLICY = [
  ...
  "connect-src 'self' blob: https://services.arcgisonline.com https://*.reearth.land https://api.rainviewer.com https://*.rainviewer.com https://api.cesium.com https://*.cesium.com",

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=WorkerEnv` (hash: 06f52242bae78a75643a0385f52d7e31)
...
interface __BaseEnv_WorkerEnv {
	...
	PUBLIC_ORIGIN?: "https://voygent-adsb-game-staging.somotravel.workers.dev" | "https://fly.voygent.app";
	TURNSTILE_SITE_KEY?: "0x4AAAAAAEMNrkMteVREAOpe" | "0x4AAAAAAEMOZw8pOCVJtNPG";
	CLOUDFLARE_ACCOUNT_ID: "5c2997e723bf93da998a627e799cd443";
	REQUEST_ANALYTICS_DATASET: "voygent_adsb_game_requests_staging" | "voygent_adsb_game_requests_production" | "voygent_adsb_game_requests_local";
	ADSB_BROKER: DurableObjectNamespace<import("./worker/index").AdsbBroker>;
	TRAFFIC_REQUEST_RATE_LIMITER?: RateLimit;
	ACCESS_TEAM_DOMAIN?: "https://loran-game.cloudflareaccess.com";
	ACCESS_AUD?: "f3f390d7f526e5f03daef1444c222e656d4411fb0ec797fc3ac5fa7da50f5c21";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ACCESS_TEAM_DOMAIN: "https://loran-game.cloudflareaccess.com";
		ACCESS_AUD: "f3f390d7f526e5f03daef1444c222e656d4411fb0ec797fc3ac5fa7da50f5c21";
		TURNSTILE_SITE_KEY: "0x4AAAAAAEMOZw8pOCVJtNPG";
		ADSB_PROVIDER_PRIMARY: "https://api.airplanes.live/v2/point/{lat}/{lon}/{radius}";
		UPSTREAM_MIN_INTERVAL: "1";
		UPSTREAM_DAILY_LIMIT: "500";
		UPSTREAM_MAX_RADIUS_NM: "250";
		CLOUDFLARE_ACCOUNT_ID: "5c2997e723bf93da998a627e799cd443";
		REQUEST_ANALYTICS_DATASET: "voygent_adsb_game_requests_production";
		ADSB_BROKER: DurableObjectNamespace<import("./worker/index").AdsbBroker>;
	}

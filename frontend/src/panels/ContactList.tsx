...
export type ContactClassFilter = "all" | "c172s" | "b738" | "f5e" | "biz" | "tprop" | "r44" | "t6" | "c130" | "unsupported";
      ...
      <div className="contact-list-header">
        ...
        <div className="contact-filters">
          ...
          >
            ...
            <option value="t6">TRAINER</option>
            <option value="c130">HEAVY TURBOPROP</option>
